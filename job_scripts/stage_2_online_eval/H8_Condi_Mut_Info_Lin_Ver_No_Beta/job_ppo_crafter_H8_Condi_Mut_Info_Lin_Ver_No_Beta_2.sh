...
cp_error_rate="0.1",rl_policy_setup_params.lang_rew_settings.has_boltzmann_rationality_coeff=false,rl_policy_setup_params.lang_rew_settings.lang_reward_function_type=cmi_linear,\
lang_rew_model_params.is_markovian=false,lang_rew_model_params.traj_length=10,lang_rew_model_params.has_extra_data_manipulation=true,\
general.seed=2565  &
