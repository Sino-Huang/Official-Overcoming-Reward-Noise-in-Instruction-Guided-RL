...
kedro run --from-nodes "setup_env_node" --to-nodes "train_rl_main_node" --params env=crafter,purpose=policy,train_rl_policy_params.eval_type_tag=H7_Condi_Mut_Info_Log_Ver_Soft,reward_machine_params.lang_reward_machine_type=standard,rl_policy_setup_params.is_int_rew_activated=false,rl_policy_setup_params.is_lang_rew_activated=true,rl_policy_setup_params.lang_rew_settings.has_hard_signal=false,rl_policy_setup_params.lang_rew_settings.hard_signal_
cp_error_rate="0.1",rl_policy_setup_params.lang_rew_settings.has_boltzmann_rationality_coeff=true,rl_policy_setup_params.lang_rew_settings.lang_reward_function_type=cmi_log,\
lang_rew_model_params.is_markovian=false,lang_rew_model_params.traj_length=10,lang_rew_model_params.has_extra_data_manipulation=true,\
general.seed=2565  &
