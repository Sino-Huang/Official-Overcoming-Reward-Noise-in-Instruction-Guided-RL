...
# pure ppo false negative sim case crafter env

kedro run --from-nodes "setup_env_node" --to-nodes "train_rl_main_node" --params "env=crafter,purpose=policy,train_rl_policy_params.eval_type_tag=H4_1_False_Negative_Sim,reward_machine_params.lang_reward_machine_type=false_negative_sim,rl_policy_setup_params.is_int_rew_activated=false,rl_policy_setup_params.is_lang_rew_activated=true,general.seed=7738" &
...
# ppo + int_rew false_negative_sim crafter env
