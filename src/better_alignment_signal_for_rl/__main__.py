"""better_alignment_signal_for_rl file for ensuring the package is executable
as `better-alignment-signal-for-rl` and `python -m better_alignment_signal_for_rl`
"""
import importlib
