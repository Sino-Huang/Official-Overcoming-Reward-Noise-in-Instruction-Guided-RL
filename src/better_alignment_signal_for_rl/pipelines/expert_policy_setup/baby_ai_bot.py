...
class BabyAIBot:
    ...
    * The bot can solve all BabyAI levels from the original paper. It can also solve
    ...
    def __init__(self, mission, is_full_observability=False):
        # Mission to be solved
        self.mission = mission
        self.is_full_observability = is_full_observability
        ...
        while len(queue) > 0:
            ...
            if cell:
                ...
                # If this is a door
                    ...
                    # but if we have full observability, we can go through
                    if not cell.is_open and not self.is_full_observability:
                        continue
    ...
    def _shortest_path(self, accept_fn, try_with_blockers=False):
        ...
        if path:
            ...
            path = path[1:] # remove the starting position
